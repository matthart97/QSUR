...
if __name__ == "__main__":
    # Load your data
    data = pd.read_csv('/home/matt/Proj/QSURv3/Data/Curated/UseCaseDataModeling.csv')
    ...
    results.to_csv('/home/matt/Proj/QSURv3/Results/BGMM/fitting_results.csv', index=False)
"""
